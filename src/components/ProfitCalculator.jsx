        ...
        <Card elevation={0} sx={{border:1,borderColor:"divider"}}>
          <CardContent>
            ...
            <Grid container spacing={2} mt={2}>
              ...
              <Grid item size={3}>
                <Input label="Label Printing (₹)" name="labelCost" onChange={handleChange} />
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2} mt={2}>
              <Grid item size={2.4}>
                <Input label="Selling Price (₹)" name="sellingPrice" onChange={handleChange} />
              </Grid>
              <Grid item size={2.4}>
                <Input label="Marketplace Fee (%)" name="marketplaceFeePercent" onChange={handleChange} />
              </Grid>
              <Grid item size={2.4}>
                <Input label="Buyer Shipping (₹)" name="buyerShipping" value={form.buyerShipping} onChange={handleChange} />
              </Grid>
              <Grid item size={2.4}>
                <Input label="GST on Fees (%)" name="gstPercent" value={form.gstPercent} onChange={handleChange} />
              </Grid>
              <Grid item size={2.4}>
                <Input label="TCS (%)" name="tcsPercent" value={form.tcsPercent} onChange={handleChange} />
              </Grid>
            </Grid>
