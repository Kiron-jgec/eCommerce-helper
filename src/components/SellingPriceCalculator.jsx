...
const Section = ({ title, children }) => (
  <Box mt={2}>
    ...
    <Box display="grid" gap={0.6}>{children}</Box>
  </Box>
);
      ...
      <Grid item size={8} md={8}>
        <Card elevation={0} sx={{ border: 1, borderColor: "divider" }}>
          <CardContent>
            ...
            {/* RISK */}
            <Typography mt={3}>🔁 Return & RTO Cost (Avg)</Typography>
            <Grid container spacing={2} mt={1}>
              <Grid item xs={12} sm={6}>
                <Input label="Return Cost (₹)" name="returnCost" onChange={handleChange} />
              </Grid>
              <Grid item xs={12} sm={6}>
                <Input label="RTO Cost (₹)" name="rtoCost" onChange={handleChange} />
              </Grid>
            </Grid>
            <Typography mt={3}>🏷 Marketplace Fee</Typography>
            ...
            {/* PROFIT */}
            <Typography mt={3}>💰 Profit</Typography>
            ...
            >
              ...
              <Grid item xs={12} sm={6}>
                <Input
                  label={form.profitType === "PERCENT" ? "Profit (%)" : "Profit (₹)"}
                  name="profitValue"
                  onChange={handleChange}
                />
              </Grid>
            ...
            {/* SHIPPING */}
            <Typography mt={3}>🚚 Optional Buyer Shipping</Typography>
            <Grid container spacing={2} mt={1}>
              <Grid item xs={12} sm={6}>
                <Input
...
>
  <CardContent>
    <Typography variant="h6">📌 Listing Price Breakdown</Typography>
    ...
    <Section title="Buying Cost">
      ...
      <Row label="Label Printing Cost" value={result.labelPrintingCost} />
      <Row strong label="Total Buying Cost" value={result.baseBuyingCost} />
    </Section>
...
const Row = ({ label, value, strong }) => (
  <Box display="flex" justifyContent="space-between">
    <Typography fontWeight={strong ? 600 : 400}>
      {label}
    </Typography>
    <Typography fontWeight={strong ? 600 : 400}>
      ₹{value}
